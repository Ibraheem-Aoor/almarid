...
class ExportsController extends BackendController {

    var $title = 'طلبات التصدير';
    var $route = 'exports';
    var $view_folder = 'exports';
    var $upload_folder = 'exports';
    private $model = null;
    ...
    public function data(Request $request){
        ...
        return \Datatables::of($objects)
            ...
            ->addColumn('car', function ($object) {if($object->export_product_id >0){
                return ExportProduct::find($object->export_product_id )->name;
            }else{
                return '--';
            }})
...
//            ->make(true);
            ->rawColumns(['car','status', 'edit_action','delete_action'])->toJson();
    }
