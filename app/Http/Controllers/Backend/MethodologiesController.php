...
class MethodologiesController extends BackendController {

    var $title = 'منهجية العمل';
    var $route = 'methodologies';
    var $view_folder = 'methodologies';
    var $upload_folder = 'methodologies';
    private $model = null;

    public function __construct(){
        parent::__construct();
        $this->model = new Methodology();
    }
