            ...
            <div class="container-fluid px-sm-5">
                <div class="d-flex align-items-center">
                    <div class="logo"><a href="/en/"><img
                                src="{{ asset('uploads/settings/' . $settings->where('key', 'app_logo')->first()->value) }}"
                                class=" wow fadeInRight" data-wow-delay="0.3s" alt="" /></a></div>
                    <div class="menu--mobile mx-lg-auto">
                        ...
                        <div class="menu-container w-100">
                            <ul class="main-menu list-main-menu d-lg-flex justify-content-start ml-xl-5">
                                <li class="menu_item"><a class="menu_link active" href="/en/about-us"
                                        data-scroll="about-us">About Company</a></li>

                                <li class="menu_item"><a class="menu_link" href="/en/cars"
                                        data-scroll="goal">Cars</a></li>
                                {{-- <li class="menu_item"><a class="menu_link" href="/en/kamaliat"    data-scroll="serv">Accessories</a></li> --}}
                                <li class="menu_item"><a class="menu_link" href="/en/export"
                                        data-scroll="why">Export </a></li>
                                <li class="menu_item"><a class="menu_link" href="/en/evaluations"
                                        data-scroll="partners">Ratings</a></li>
                                <li class="menu_item"><a class="menu_link" href="/en/learn"
                                        data-scroll="partners">How to Buy</a></li>
                                <li class="menu_item"><a class="menu_link" href="/en/contact"
                                        data-scroll="partners">Contact Us</a></li>
                                <li class="menu_item"><a class="menu_link d-md-none" href="/en/tracking"
                                        data-scroll="partners">Track your Order</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="menu-container">
                        <ul class="main-menu d-flex align-items-center">
                            <li class="menu_item downlaod-app"><a
                                    class="btn btn-primary btn-sm  wow fadeInLeft scrollTo rounded px-3"
                                    data-wow-delay="0.3s" target="_blank"
                                    href="{{ $settings->where('key', 'google_play')->first()->value }}"
                                    data-scroll="contact"> <i class="fab fa-google-play pr-2"></i> Download the
                                    app</a></li>

                            <li class="menu_item"><a
                                    class="btn btn-primary d-md-block d-none mx-2 btn-sm  wow fadeInLeft scrollTo rounded px-3 bg-tomato"
                                    href="/en/tracking"> <i class="fab fa-searchengin pr-2"></i></i>Track your
                                    Order</a></li>



                            <li class="menu_item"><a
                                    class="btn btn-primary px-3 ml-2   btn-sm rounded   wow fadeInLeft scrollTo"
                                    data-wow-delay="0.3s" href="@yield('url')" data-scroll="contact"> <img
                                        src="{{ asset('web/assets/images/ksa.png') }}" alt=""> </a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="single-footer">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="/en/"><i class="fas fa-chevron-left pr-2"></i>Home</a> </li>
                                <li><a href="/en/about-us"><i class="fas fa-chevron-left pr-2"></i>About Company</a>
                                </li>
                                <li><a href="/en/contact"><i class="fas fa-chevron-left pr-2"></i>Contact Us</a> </li>
                                <li><a href="/en/condition"><i class="fas fa-chevron-left pr-2"></i> Tearms and
                                        Conditions</a> </li>
                                <li><a href="/en/privacyPolicy.php"><i class="fas fa-chevron-left pr-2"></i> Privacy
                                        Policy</a> </li>
                            </ul>
                    ...
                    <div class="col-lg-3">
                        <div class="single-footer">
                            ...
                            <ul class="list-unstyled">
                                <li><a href="/en/offers"><i class="fas fa-chevron-left pr-2"></i>Latest Orders</a>
                                </li>
                                <li><a href="/en/cars"><i class="fas fa-chevron-left pr-2"></i>Latest Cars</a> </li>
                                <li><a href="/en/common-questions"><i class="fas fa-chevron-left pr-2"></i>Common
                                        Questions</a> </li>
                            </ul>
                        </div>
                    </div>
                    @foreach ($addresses as $address)
                        <div class="col-lg-3">
                            <div class="single-footer">
                                <h3 class="mb-3">{{ $address->branch_en }}</h3>
                                <ul class="list-unstyled">
                                    <li><a href="#"><i class="fas fa-phone pr-2"></i>{{ $address->fax }}</a>
                                    </li>
                                    <li><a href="#"><i class="fal fa-headset pr-2"></i>
                                            {{ $address->phonenumber }}</a></li>
                                    <li><a href="{{ $address->map }}" target="_blank"><i
                                                class="fal fa-map-marker-check pr-2"></i>{{ $address->address_en }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="socialFooter ">
                    <ul class="list-unstyled d-flex align-items-center   flex-wrap">
                        <li class="mr-4   wow fadeInDown" data-wow-delay="0.2s">
                            <a href="{{ $settings->where('key', 'facebook')->first()->value }}" target="_blank"> <i
                                    class="fab fa-facebook-f"></i> </a>
                        </li>
                        <li class="mr-4   wow fadeInDown" data-wow-delay="0.3s">
                            <a href="{{ $settings->where('key', 'twitter')->first()->value }}" target="_blank"> <i
                                    class="fab fa-twitter"></i> </a>
                        </li>
                        <li class="mr-4   wow fadeInDown" data-wow-delay="0.4s">
                            <a href="{{ $settings->where('key', 'instagram')->first()->value }}" target="_blank"> <i
