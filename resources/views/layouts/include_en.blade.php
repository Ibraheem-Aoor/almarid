...
<header class="main-header transition  @yield('white')">
  <div class="container-fluid px-sm-5">
    <div class="d-flex align-items-center">
      <div class="logo"><a href="/en/"><img src="{{ asset('uploads/settings/'.$settings->where('key','app_logo')->first()->value) }}" class=" wow fadeInRight" data-wow-delay="0.3s" alt=""/></a></div>
      <div class="menu--mobile mx-lg-auto">
        ...
        <div class="menu-container w-100">
          <ul class="main-menu list-main-menu d-lg-flex justify-content-start ml-xl-5" >
            ...
            <li class="menu_item"><a class="menu_link" href="/en/contact"   data-scroll="partners">Contact Us</a></li>
             <li class="menu_item"><a class="menu_link d-md-none"   href="/en/tracking"  data-scroll="partners">Track your Order</a></li>
          </ul>
        </div>
      </div>
 ...
 <div class="col-lg-3">
   <div class="single-footer">
     ...
     <ul class="list-unstyled">
      ...
      <li><a href="/en/about-us" ><i class="fas fa-chevron-left pr-2"></i>About Company</a> </li>
      <li><a href="/en/contact" ><i class="fas fa-chevron-left pr-2"></i>Contact Us</a> </li>
      <li><a href="/en/condition" ><i class="fas fa-chevron-left pr-2"></i> Tearms and Conditions</a> </li>
      <li><a href="/en/privacyPolicy.php" ><i class="fas fa-chevron-left pr-2"></i> Privacy Policy</a> </li>
    </ul>
 ...
 <div class="col-lg-3">
   <div class="single-footer">
     ...
     <ul class="list-unstyled">
      <li><a href="/en/offers" ><i class="fas fa-chevron-left pr-2"></i>Latest Orders</a> </li>
      <li><a href="/en/cars" ><i class="fas fa-chevron-left pr-2"></i>Latest Cars</a> </li>
      <li><a href="/en/common-questions" ><i class="fas fa-chevron-left pr-2"></i>Common Questions</a> </li>
    </ul>
   </div>
 </div>
...
<div class="col-lg-3">
  <div class="single-footer">
    <h3 class="mb-3">Branch  {{$address->branch_en}}</h3>
    <ul class="list-unstyled">
      <li><a href="#"><i class="fas fa-phone pr-2"></i>{{$address->fax}}</a> </li>
      <li><a href="#"><i class="fal fa-headset pr-2"></i>  {{$address->phonenumber}}</a></li>
      <li><a href="{{$address->map}}"   target="_blank" ><i class="fal fa-map-marker-check pr-2"></i>{{$address->address_en}}</a> </li>
    </ul>
  </div>
</div>
 @endforeach
