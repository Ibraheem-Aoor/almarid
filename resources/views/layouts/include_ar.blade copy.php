          ...
          <div class="d-flex align-items-center">
            ...
            <div class="menu--mobile mx-lg-auto">
              ...
              <div class="menu-container w-100">
                <ul class="main-menu list-main-menu d-lg-flex justify-content-start ml-xl-5" >
                  <li class="menu_item"><a class="menu_link active" href="/" data-scroll="about-us">عن الشركة</a></li>
            ...
            <div class="menu-container">
              <ul class="main-menu d-flex align-items-center">
                <li class="menu_item"><a class="btn btn-primary btn-sm  wow fadeInLeft scrollTo rounded px-3 "   target="_blank" href="{{$settings->where('key','google_play')->first()->value}}"> <i class="fab fa-google-play pr-2"></i> حمل التطبيق</a></li>
                
                  <li class="menu_item"><a class="btn btn-primary btn-sm  wow fadeInLeft scrollTo rounded px-3 bg-tomato"   target="_blank" href="{{$settings->where('key','google_play')->first()->value}}"> <i class="fas fa-search-location pr-2"></i>تتبع طلبك</a></li>
 ...
 <footer >
  ...
  <div class="col-lg-3">
    <div class="single-footer">
      ...
      <ul class="list-unstyled">
       <li><a href="/"><i class="far fa-chevron-left pr-2"></i></a> الرئيسية</li>
       <li><a href="/contact"><i class="far fa-chevron-left pr-2"></i></a> اتصل بنا</li>
       <li><a href="/condition"><i class="far fa-chevron-left pr-2"></i></a> الشروط والأحكام</li>
       <li><a href="/privacyPolicy"><i class="far fa-chevron-left pr-2"></i></a> سياسة الخصوصية</li>
     </ul>
  ...
  <div class="col-lg-3">
    <div class="single-footer">
      ...
      <ul class="list-unstyled">
       <li><a href="/offers"><i class="far fa-chevron-left pr-2"></i></a> أخر العروض</li>
       <li><a href="/cars"><i class="far fa-chevron-left pr-2"></i></a> أحدث السيارات</li>
       <li><a href="/common-questions"><i class="far fa-chevron-left pr-2"></i></a> الأسئلة الشائعة</li>
     </ul>
    </div>
  </div>
  ...
  <div class="col-lg-3">
   <div class="single-footer">
     ...
     <ul class="list-unstyled">
       <li style="direction:ltr"><i style="float: right;" class="far fa-phone pr-2"></i>{{$address->fax}}</li>
       <li style="direction:ltr"><i class="fal fa-headset pr-2" style="float: right;"></i> {{$address->phonenumber}}</li>
       <li><i class="fal fa-map-marker-check pr-2"></i> {{$address->address}}</li>
     </ul>
   </div>
 </div>
 @endforeach
    ...
    <div class="lastFooter py-3  container-fluid px-5 d-flex align-items-center justify-content-between ">
      <p>© 2022 جميع الحقوق محفوظة | شركة ويدو</p>
  ...
  <div class="page-tolpar">
  
     <a   target="_blank" href="https://wa.me/{{$settings->where('key','whatsapp')->first()->value}}">
