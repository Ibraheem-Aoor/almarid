...
<body>
    ...
    <div class="main-wrapper">
                    ...
                    <div class="menu--mobile mx-lg-auto">
                        ...
                        <div class="menu-container w-100">
                            <ul class="main-menu list-main-menu d-lg-flex justify-content-start ml-xl-5">
                                <li class="menu_item"><a class="menu_link active" href="/about-us"
                                        data-scroll="about-us">عن الشركة</a></li>

                                <li class="menu_item"><a class="menu_link" href="/cars"
                                        data-scroll="goal">المركبات</a></li>
                                {{-- <li class="menu_item"><a class="menu_link"    href="/kamaliat"  data-scroll="serv">الكماليات</a></li> --}}
                                <li class="menu_item"><a class="menu_link" href="/export" data-scroll="why">التصدير
                                    </a></li>
                                <li class="menu_item"><a class="menu_link" href="/evaluations"
                                        data-scroll="partners">التقييمات</a></li>
                                <li class="menu_item"><a class="menu_link" href="/learn"
                                        data-scroll="partners">طريقة الشراء</a></li>
                                <li class="menu_item"><a class="menu_link" href="/contact"
                                        data-scroll="partners">تواصل معنا</a></li>
                                <li class="menu_item"><a class="menu_link d-md-none" href="/tracking"
                                        data-scroll="partners">تتبع طلبك</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="menu-container">
                        <ul class="main-menu d-flex align-items-center">
                            <li class="menu_item downlaod-app"><a
                                    ...
                                    data-scroll="contact"> <i class="fab fa-google-play pr-2"></i> حمل التطبيق</a></li
                                <li class="menu_item"><a
                                class="btn btn-primary d-md-block d-none mx-2 btn-sm  wow fadeInLeft scrollTo rounded px-3 bg-tomato"
                                href="/tracking"> <i class="fab fa-searchengin pr-2"></i></i>تتبع طلبك</a></li>
                            ...
                            <li class="menu_item"><a
                                    ...
                                    data-wow-delay="0.3s" href="@yield('url')" data-scroll="contact"> <img
                                        src="{{ asset('web/assets/images/usa.png') }}" alt=""> </a></li>
                    ...
                    <div class="col-lg-3">
                        <div class="single-footer">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="/condition"><i class="fas fa-chevron-left pr-2"></i> الشروط والأحكام</a>
                                </li>
                                <li><a href="/privacyPolicy.php"><i class="fas fa-chevron-left pr-2"></i> سياسة
                                        الخصوصية</a> </li>
                            </ul>
                    ...
                    <div class="col-lg-3">
                        <div class="single-footer">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><a href="/common-questions"><i class="fas fa-chevron-left pr-2"></i>الأسئلة
                                        الشائعة</a> </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-2">
                            <div class="single-footer">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a target="_blank" href="{{ $address->map }}"><i
                                                class="fal fa-map-marker-check pr-2"></i>{{ $address->address }}</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="page-tolpar"> <a target="_blank"
                href="https://wa.me/{{ $settings->where('key', 'whatsapp')->first()->value }}">
