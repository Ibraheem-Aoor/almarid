                      ...
                      <div class="tab-content">  <?php $p=0;?>
                        ...
                        <div class="caro-details bg-white rounded-max px-4 py-4 mt-4 ">
                          ...
                          <div class="car-name_price d-flex align-items-center justify-content-start flex-wrap mt-4">
                            ...
                            <h4 class="mb-2 mb-lg-0 mr-4"> <i class="fas fa-map-marker-alt mr-2 orange"></i>  + {{$address->branch}} - {{$address->phonenumber}}</h4>
                            @endforeach
                            @endif
                        ...
                        <div class="order-now mt-3">
                            <button  data-toggle="modal" data-target="#exportModal" class="btn pt-3 ob-2 bg-orange text-white rounded w-100">ااطلبـها الان</button>
                        </div>
...
<div class="col-lg-12 mb-3">
      <div class="form-group"> 
                ...
                <input class="form-control" name="export_product_name" value="{{$product->name}}" disabled type="text" />
      </div>
    </div>
