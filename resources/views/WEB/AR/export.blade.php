...
<div class="container my-4">
          ...
          <div class="container mt-5">
            ...
            <div class="col-lg-5 mt-4 mt-lg-0">
              ...
              <form action="{{route('ar.send.export')}}" class="    wow fadeInDown   " data-wow-delay="0.2s">
                  ...
                  <div class="single_export__car px-4 py-4 bg-white border    wow fadeInDown   " data-wow-delay="0.2s">
                    <div class="row align-items-center">
                      ...
                      <div class="col-lg-8">
                        ...
                        <p class="bg-dark px-4 pt-3 pb-2 text-white rounded">  <span>${{$product->price_dollar}}</span> | <span>{{$product->price}} درهم</span></p> 
                        </div>
                        <hr class="line">
                        ...
                        <div class="car-btns d-flex align-items-center justify-content-start flex-wrap">
                          <button class="btn px-4 bg-main pt-2 pb-1 text-white mr-4 open-AddBookDialog " data-name="{{$product->name}}" data-id="{{$product->id}}" data-toggle="modal" href="#exportModal"> مهتـم </button>
                        <a href="/export/car/{{$product->id}}"> <button class="btn px-4 bg-orange pt-2 pb-1 text-white mr-4"> رؤية التفاصيل </button></a>  
                        </div>
                      </div>
                    </div>
                  </div>
