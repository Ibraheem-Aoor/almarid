    ...
    <div class="container my-4">
        ...
        <div class="container mt-5">
            ...
            <div class="avilable__cars">
                <h2 class="orange text-center mt-5 under__line   wow fadeInUp  " data-wow-delay="0.2s">السيارات المتوفرة
                </h2>
                <div class="row mt-5">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="car-btns d-flex align-items-center justify-content-start flex-wrap">
                                            <button class="btn px-4 bg-main pt-2 pb-1 text-white mr-4 open-AddBookDialog "
                                                ...
                                                data-toggle="modal" href="#exportModal"> مهتـم </button>
                                            <a href="/export/car/{{ $product->id }}"> <button
                                                    class="btn px-4 bg-orange pt-2 pb-1 text-white mr-4"> رؤية التفاصيل
                                                </button></a>
                                        </div>
                                    </div>
                                </div>
