    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">اضافة رأي</h5>
    ...
    <div class="col-lg-6 mb-3">
      ...
      <div class="col-lg-6  mb-3 ">
        <div class="single-filter">
          <select
          class="selectpicker" name="country_id" required title="اختر دولة">
    ...
    <div class="col-lg-6 mb-3">
      <div class="picture-container d-flex">
        <div class="img-plus d-flex flex-wrap">
            <div class="container-plus"><label class="fas fa-plus" for="input-plus"> <span>اضافة صورة أو فيديو</span> </label><input class="input-add" type="file" id="input-plus" name="image"></div>
        </div>
    </div>
    </div>
