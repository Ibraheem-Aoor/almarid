...
<div class="container">
  ...
  <h2 class="  text-center mt-5 orange"> الكماليـات</h2>

  <div class="row mt-5" >
      <div class="col-lg-10 mx-auto">
          <div class="status_cont  bg-white rounded-max px-4 py-5">
          <div class="img-status text-center">
              <img src="{{asset('web/assets/images/undraw_by_my_car_ttge.svg')}}" class="img-fluid" alt="">
              <h3 class="mt-4">الصفحة قيد التطوير <a href="/">انتقل للصفحة الرئيسية</a></h3>
          </div>
      </div>
