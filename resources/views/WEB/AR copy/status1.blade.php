            ...
            <div class="row mt-5" >
                <div class="col-lg-10 mx-auto">
                    ...
                    <div class="img-status text-center">
                        <img src="./assets/images/undraw_order_confirmed_1m3v.svg" class="img-fluid" alt="">
                        <h3 class="mt-4">طلبك الآن في المرحلة الأولى بانتظار التدقيق</h3>
                    </div>
                </div>
                <div class="contact-quic text-center mt-4">
                    ...
                    <a href="#"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="120" height="120" viewBox="0 0 120 120">
                        <defs>
