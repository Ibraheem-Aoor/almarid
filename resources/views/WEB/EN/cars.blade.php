...
@section('content')
    ...
    <div class="box-search w-100 py-5 mt-5 bg-main">
        <div class="container">
            ...
            <form action="{{ route('en.cars.search') }}" method="GET">
                {{ csrf_field() }}
                <div class="row mt-3">
                    ...
                    <div class="col-lg-3 col-md-6 mb-3 mb-lg-0">
                        <div class="single-filter">
                            <select name="brand_id" class="selectpicker" title="Company">
                                <option value="">--</option>
                        ...
                        <a href="/en/car/{{ $product->id }}">
                            <div class="single-mainCar">
                                ...
                                <div class="maincar-price d-flex align-items-center justify-content-between">
                                    <h5 class="color bold">{{ $product->offer_price ?? $product->price }} Dirham</h5>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="name" type="text"
                                        value="{{ $name }}" placeholder="Search for a Car" />
                                </div>
                            </div>
                            <div class="col-12">
                                    ...
                                    <select class="selectpicker" name="category_id" title="Car Type">
                                        ...
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if ($category->id == $category_id) selected @endif>{{ $category->name_en }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                    ...
                                    <select class="selectpicker" name="fuel_id" title="Feul">
                                        ...
                                        @foreach ($fuels as $fuel)
                                            <option value="{{ $fuel->id }}"
                                                @if ($fuel->id == $fuel_id) selected @endif>{{ $fuel->name_en }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
