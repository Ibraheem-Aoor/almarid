                  ...
                  <div class="single_export__car px-4 py-4 bg-white border    wow fadeInDown   " data-wow-delay="0.2s">
                    <div class="row align-items-center">
                      ...
                      <div class="col-lg-8">
                        ...
                        <p class="bg-dark px-4 pt-3 pb-2 text-white rounded">  <span>${{$product->price_dollar}}</span> | <span>{{$product->price}} Dirham</span></p> 
                        </div>
                        <hr class="line">
                        <div class="car__feature_export">
                          <ul class="list-unstyled d-flex align-items-center justify-content-start flex-wrap ">
                            <li class="mb-3 d-flex align-items-center mr-3">
                              <span><img src="{{asset('web/assets/images/Icon_ feather-calendar.svg')}}" alt=""></span>      <p class="mt-1 ml-3 "> {{$product->model}}</p>
                            </li>
                            <li class="mb-3 d-flex align-items-center mr-3">
                              <span><img src="{{asset('web/assets/images/steering-wheel.svg')}}" alt=""></span>      <p class="mt-1 ml-3 "> {{$product->geer}} </p>
                            </li>
                            <li class="mb-3 d-flex align-items-center mr-3">
                              <span><img src="{{asset('web/assets/images/steering-wheel.svg')}}" alt=""></span>      <p class="mt-1 ml-3 "> {{$product->wheel_drive}} </p>
                            </li>
                            <li class="mb-3 d-flex align-items-center mr-3">
                              <span><img src="{{asset('web/assets/images/turbo-engine.svg')}}" alt=""></span>      <p class="mt-1 ml-3 "> {{$product->loaction}}</p>
                            </li>
                          </ul>
                        </div>
                        <div class="car-btns d-flex align-items-center justify-content-start flex-wrap">
                          <button class="btn px-4 bg-main pt-2 pb-1 text-white mr-4 open-AddBookDialog " data-name="{{$product->name_en}}" data-id="{{$product->id}}" data-toggle="modal" href="#exportModal"> Interested </button>
                        <a href="/en/export/car/{{$product->id}}"> <button class="btn px-4 bg-orange pt-2 pb-1 text-white mr-4">More Details</button></a>  
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{route('en.send.export')}}" class="" data-wow-delay="0.2s"  method="POST">{{csrf_field()}}
...
<div class="col-lg-12 mb-3">
      <div class="form-group"> 
                ...
                <input class="form-control" name="export_product_id" id="export_product_id" value=""  type="hidden" />
                <input class="form-control" name="export_product_name" id="export_product_name" value="" disabled type="text" />
      </div>
    </div>
