...
@section('content')
    <div class="container my-4">
        <div class="top-navLinks d-flex align-items-center justify-content-between flex-wrap ">
            ...
            <div class="add-opinion">
                <button class="btn px-5 rounded bg-main text-white pt-2 pb-1" data-toggle="modal"
                    data-target="#testimonialsModal"> <i class="fas fa-heart mr-2"></i> Add your Opinion</button>
            </div>
        </div>
        ...
        <div class="testimonialPage__cont mt-5">
            <div class="row">
                ...
                @endforeach
                <img src="{{asset('/web/assets/images/ratings-updated-6.png')}}" class="mr-3" alt="">
            </div>
        </div>
    ...
    <!-- Modal -->
    <div class="modal fade modal-filter" id="testimonialsModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('evaluation') }}" data-wow-delay="0.2s" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6  mb-3 ">
                                <div class="single-filter">
                                    <select class="selectpicker" name="country_id" required title="Choose Country">
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="picture-container d-flex">
                                    <div class="img-plus d-flex flex-wrap">
                                        <div class="container-plus"><label class="fas fa-plus" for="input-plus"> <span>Add
                                                    Photo or Video</span> </label><input class="input-add" type="file"
                                                id="input-plus" name="image"></div>
                                    </div>
                                </div>
                            </div>
