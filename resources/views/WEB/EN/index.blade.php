...
<div class="content-wrap text-center wow fadeInUp" data-wow-delay="0.2s">
  ...
  <div class="search-field  ">
    <form action="">
    <input class="search" type="search" name="" id="" placeholder="Search for a Car"  data-toggle="modal" data-target="#exampleModal">
...
<section class="offers">
  <div class="container">
    <div class="top-tittle d-flex align-items-center justify-content-between">
      ...
      <a class="btn btn-primary btn-sm  wow fadeInLeft scrollTo rounded px-5"  data-wow-delay="0.3s" href="/en/offers"  >  More</a>
    </div>
    <div class="row mt-5">
...
<section class="  latest-cars">
  <div class="container">
    <div class="top-tittle d-flex align-items-center justify-content-between">
      ...
      <a class="btn btn-primary btn-sm  wow fadeInLeft scrollTo rounded px-5"  data-wow-delay="0.3s" href="/en/cars"  >  More</a>
    </div>
    <div class="row mt-5">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <form action="{{route('contact')}}" class="mt-4    wow fadeInDown   " data-wow-delay="0.2s"  method="POST">{{csrf_field()}}
          ...
          <button  type="submit" class="btn btn-primary btn-sm hover-transform px-5 box-shadow rounded mx-auto   mt-3   wow fadeInDown" data-wow-delay="0.2s" href="">send </button>
...
<div class="row">
    <div class="col-12"><div class="form-group"> 
        <label> Name</label>
        <input class="form-control" name="name" type="text" value="" placeholder="Search for a Car"/>
      </div></div>
