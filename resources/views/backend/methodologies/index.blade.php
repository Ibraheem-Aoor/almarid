...
<script>
    $(document).ready(function() {
        ...
        TABLE.DataTable({
            ...
            columns: [
                {className: 'text-center', data: 'title', name: 'title', searchable: true,orderable: true},
...
//                $('.textarea').wysihtml5();
    ...
    function postData(form){
        ...
        $.ajax({
            ...
            error:function(data) {
                console.log(data);
                showAlertMessage('alert-danger', 'الرجاء ارفاق ملف بصيغة مدعومة - صورة  فقط');
            } ,
            statusCode: {
                500: function(data) {
                    console.log(data);
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="title" id="title" placeholder="الاسم">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="title_en" id="title_en" placeholder="الاسم">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <textarea name="description" class="form-control textarea" rows="5" placeholder="التفاصيل"></textarea>
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <textarea name="description_en" class="form-control textarea" rows="5" placeholder="التفاصيل"></textarea>
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
