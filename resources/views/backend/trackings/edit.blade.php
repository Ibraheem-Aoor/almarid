                            ...
                            <div class="col-md-12">
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-md-line-input has-success">
                                                <label class="col-md-2 control-label" for="sort">رقم الحالة</label>
                                                <div class="col-md-10">
                                                    <input type="number" class="form-control" name="sort" id="sort" value="{{ $object->sort }}" placeholder="رقم الحالة">
                                                    <div class="form-control-focus">
                                                    </div>
                                                    <span class="help-block"></span>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    @if(!empty($object->image))
                                                        <img src="{{ asset('uploads/'.$data['file_folder'].'/'.$object->image) }}" width="100px" alt="">
                                                    @else
