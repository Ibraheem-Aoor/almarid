...
<script>
    $(document).ready(function() {
        ...
        TABLE.DataTable({
			...
			ajax: "{!! url(config('app.prefix', 'admin') . '/' . $data['route'] . '/data') . '?order_status='.Request::get('order_status') !!}",
            columns: [
                ...
                {className: 'text-center', data: 'product_name', name: 'product_name', searchable: false,orderable: false},
                {className: 'text-center', data: 'tracking', name: 'tracking', searchable: false,orderable: true},
        ...
        <section class="content">
            <div class="row">
				<div class="col-md-12" style="margin: 15px;">
					<form action="">
						<b>فرز حسب الحالة</b>:
						<select onchange="this.form.submit();" class="" name="order_status" id="">
							<option {{ (Request::get('order_status') == '')? 'selected' : '' }} value="">الكل</option>
							<option {{ (Request::get('order_status') == '1')? 'selected' : '' }} value="1">المرحلة الأولى</option>
							<option {{ (Request::get('order_status') == '2')? 'selected' : '' }} value="2">المرحلة الثانية</option>
							<option {{ (Request::get('order_status') == '3')? 'selected' : '' }} value="3">مرحلة التدقيق</option>
						</select>
					</form>
				</div>
                <div class="col-xs-12">
                        ...
                        <div class="box-body">
                            <table class="table table-striped table-bordered table-hover" id="objects_table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="20%">الجوال</th>
