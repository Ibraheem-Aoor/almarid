                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <textarea name="text" class="form-control textarea" rows="5" placeholder="التفاصيل"></textarea>
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="youtube" id="name" placeholder="رابط اليوتيوب">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
