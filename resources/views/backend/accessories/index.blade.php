															...
															<div class="row">
																...
																<div class="col-md-12">
																	<div class="form-group form-md-line-input has-success">
																		...
																		<div class="col-md-10">
																			<input type="text" class="form-control" name="name_en" id="name" placeholder="" autocomplete="off">
																			<div class="form-control-focus">
																			</div>
																			<span class="help-block"></span>
																		</div>
																...
																<div class="col-md-12">
																	<div class="form-group form-md-line-input has-success">
																		...
																		<div class="col-md-10">
																			<input type="text" class="form-control" name="price" id="name" placeholder="السعر" autocomplete="off">
																			<div class="form-control-focus">
																			</div>
																			<span class="help-block"></span>
																		</div>
																...
																<div class="col-md-12">
																	<div class="form-group form-md-line-input has-success">
																		...
																		<div class="col-md-10">
																			<input type="number" class="form-control" name="quantity" id="quantity" placeholder="" autocomplete="off">
																			<div class="form-control-focus">
																			</div>
																			<span class="help-block"></span>
																		</div>
