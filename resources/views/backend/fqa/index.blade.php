...
<script>
    $(document).ready(function() {
        ...
        TABLE.DataTable({
            ...
            columns: [
                {className: 'text-center', data: 'question', name: 'question', searchable: true,orderable: true},
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        <label class="col-md-2 control-label" for="question">السؤال</label>
                                                                        <div class="col-md-10">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <textarea name="answer" class="form-control textarea"  rows="5" placeholder="الإجابة"></textarea>
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <table class="table table-striped table-bordered table-hover" id="objects_table">
                                <thead>
                                <tr>
                                    <th class="text-center" width="50%">السؤال</th>
