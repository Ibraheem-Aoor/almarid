            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <form action="" method="get" class="pull-left" style="margin-right: 30px;">
                        <select name="status" class="pull-left form-control" style="width: 120px;padding: 0;margin-left: 5px;">
                            <option  @if(isset($_GET['status']) && $_GET['status'] == 1) selected @endif value="1">تمت المشاهدة</option>
                            <option  @if(isset($_GET['status']) && $_GET['status'] == 0) selected @endif value="0">قيد الانتظار</option>
                            </select>
                        ...
                        <div class="box-body">
                            <table class="table table-striped table-bordered table-hover" id="objects_table">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center" width="15%">رقم الجوال</th>
                                    <th class="text-center" width="15%">الرسالة</th>
