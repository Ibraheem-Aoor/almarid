...
<script>
    $(document).ready(function() {
        ...
        TABLE.DataTable({
            ...
            columns: [
                {className: 'text-center', data: 'branch', name: 'branch', searchable: true,orderable: true},
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        <label class="col-md-2 control-label" for="fax"  style="direction: ltr;" >الفاكس</label>
                                                                        <div class="col-md-10">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        <label class="col-md-2 control-label" for="phonenumber"  style="direction: ltr;" >رقم الجوال</label>
                                                                        <div class="col-md-10">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="map" id="lng" placeholder="Google Map">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                    ...
                    <div class="box">
                        <div class="box-body">
                            <table class="table table-striped table-bordered table-hover" id="objects_table">
                                <thead>
                                <tr>
                                    <th class="text-center" width="50%">الفرع</th>
