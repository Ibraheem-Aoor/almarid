                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="name_en" id="name" placeholder="الاسم الانجليزي">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
  ...
  <div class="col-md-12">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="make" id="name" placeholder="المصنع">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="year" id="name" placeholder="السنة">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="model" id="name" placeholder="الموديل">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="number" class="form-control" name="price" id="name" placeholder="السعر">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="number" class="form-control" name="price_dollar" id="name" placeholder="السعر بالدولار">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="body_style" id="name" placeholder="الشكل">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="stack_number" id="name" placeholder="رقم المخزون">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="mileage" id="name" placeholder="العداد">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="loaction" id="name" placeholder="الموقع">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="engine" id="name" placeholder="محرك">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="number" class="form-control" name="door" id="name" placeholder="عدد الأبواب">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="warranty" id="name" placeholder="الضمان">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="bhp" id="name" placeholder="حصان">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="phone" id="name" placeholder="عنوان ورقم جوال">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        ...
                                                                        <div class="col-md-10">
                                                                            <input type="text" class="form-control" name="phone1" id="name" placeholder="عنوان ورقم جوال">
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                                                                        </div>
