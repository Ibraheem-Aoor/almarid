                            ...
                            <table class="table table-striped table-bordered table-hover" id="objects_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center" width="20%">SOLD OUT</th>
                                                        ...
                                                        <div class="form-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        <label class="col-md-2 control-label"
                                                                            for="category_id">نوع السيارة</label>
                                                                        <div class="col-md-10">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        <label class="col-md-2 control-label"
                                                                            for="brand_id">العلامة التجارية</label>
                                                                        <div class="col-md-10">
                                                                ...
                                                                @if (isset($data['options_category']) &&
                                                                        !empty($data['options_category']) &&
                                                                        count($data['options_category']->toArray()) > 0)
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <label class="col-md-4 control-label"
                                                                            for="image">الصور الدخلية</label>
                                                                        <div class="col-md-8">
                                                                            <input type="file" class="form-control"
                                                                                name="images[]" placeholder="address"
                                                                                multiple>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_product_single_image', function(e) {
                ...
                e.preventDefault();
                $.ajax({
                    url: '{{ url(config('app.prefix', 'admin') . '/' . $data['route'] . '/delete_image') }}/' +
                        $(this).data('imageid'),
                    data: {
                        _token: '{!! csrf_token() !!}'
                    },
                    ...
                    success: function(data) {
                        if (data.success) {
                            ...
                            showAlertMessage('alert-danger',
                                ' حدث خطا أثناء الحذف ! حاول مجددا');
                        }
                    },
                    error: function(data) {
                        console.log(data);
        ...
        function ch_st(id , type) {
            $.ajax({
                url: '{{ url(config('app.prefix', 'admin') . '/' . $data['route'] . '/change_status') }}' + '?type='+type,
                data: {
                    id: id,
                    _token: '{!! csrf_token() !!}'
                },
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    var str = '<span class="inc"></span><span class="check"></span><span class="box"></span>' +
                        status;
                    if (status === 'مفعل') {
                        $('#' + type + '_label_status_' + id).removeClass('btn-danger');
                        $('#' + type + '_label_status_' + id).addClass('btn-success');
                    } else {
                        $('#' + type + '_label_status_' + id).addClass('btn-danger');
                        $('#' + type + '_label_status_' + id).removeClass('btn-success');
                    }
                    setTimeout(function() {
                        $('#' + type + '_label_status_' + id).html(str)
                    }, 0);
