...
@section('css')
    ...
    <style>
        ...
        .ion-icon-list i.active,.ion-icon-list i:hover{
            color: #eee;
            background: #000;
            border-radius: 5px;
        }
...
<script>
    ...
    $(document).ready(function() {
       $(document).on('click','.ion-icon-list i',function(){
            $('.ion-icon-list i').removeClass('active');
            $(this).addClass('active');
            $('.icon_value').val($(this).data('value'));
       })
    });
