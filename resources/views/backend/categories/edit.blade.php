                                            ...
                                            <div class="form-group form-md-line-input has-success">
                                                ...
                                                <div class="col-md-10">
                                                    <select name="type" class="form-control">
                                                        <option  @if($object->type == 'CAR') selected @endif value="CAR">تصنيفات السيارات</option>
                                                        <option  @if($object->type == 'FAQ') selected @endif value="FAQ">تصنيفات الأسئلة الشائعة</option>
                                                        <option  @if($object->type == 'OPTIONS') selected @endif value="OPTIONS">تصنيفات خيارات السيارات</option>
                                                        <option  @if($object->type == 'ACCESSORY') selected @endif value="ACCESSORY">تصنيفات الاكسسوارات</option>
                                                    </select>
                                                    <div class="form-control-focus">
                                                    </div>
                                                    <span class="help-block"></span>
