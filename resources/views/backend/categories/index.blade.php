                ...
                <div class="col-xs-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        <label class="col-md-2 control-label" for="type">النوع</label>
                                                                        <div class="col-md-10">
                                                                            <select name="type" class="form-control">
                                                                                <option value="CAR">تصنيفات السيارات</option>
                                                                                <option value="FAQ">تصنيفات الأسئلة الشائعة</option>
                                                                                <option value="OPTIONS">تصنيفات خيارات السيارات</option>
                                                                                <option value="ACCESSORY">تصنيفات الاكسسوارات</option>
                                                                            </select>
                                                                            <div class="form-control-focus">
                                                                            </div>
                                                                            <span class="help-block"></span>
                    ...
                    <form action="" method="get" class="pull-left" style="margin-right: 30px;">
                        <select name="type" class="pull-left form-control" style="width: 120px;padding: 0;margin-left: 5px;">
                            <option  @if(isset($_GET['type']) && $_GET['type'] == 'CAR') selected @endif value="CAR">تصنيفات السيارات</option>
                            <option  @if(isset($_GET['type']) && $_GET['type'] == 'FAQ') selected @endif value="FAQ">تصنيفات الأسئلة الشائعة</option>
                            <option  @if(isset($_GET['type']) && $_GET['type'] == 'OPTIONS') selected @endif value="OPTIONS">تصنيفات خيارات السيارات</option>
                            <option  @if(isset($_GET['type']) && $_GET['type'] == 'ACCESSORY') selected @endif value="ACCESSORY">تصنيفات الاكسسوارات</option>
                        </select>
