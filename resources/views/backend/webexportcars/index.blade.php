...
<script>
    $(document).ready(function() {
        ...
        TABLE.DataTable({
            ...
            columns: [
                {className: 'text-center', data: 'product', name: 'product', searchable: true,orderable: true},
                {className: 'text-center', data: 'color', name: 'color', searchable: true,orderable: true},
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        <label class="col-md-2 control-label" for="category_id">اسم السيارة</label>
                                                                        <div class="col-md-10">
                                                                ...
                                                                <div class="col-md-12">
                                                                    <div class="form-group form-md-line-input has-success">
                                                                        <label class="col-md-2 control-label" for="colors">اللون</label>
                                                                        <div class="col-md-10">
                    ...
                    <div class="box">
                        <div class="box-body">
                            <table class="table table-striped table-bordered table-hover" id="objects_table">
                                <thead>
                                <tr>
                                    <th class="text-center" width="50%">السيارة</th>
                                    <th class="text-center" width="20%">اللون</th>
